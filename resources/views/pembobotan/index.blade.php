        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <form action="{{route('pembobotan.store')}}" x-data="{
        ...
        <div class="panel-body">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    <form action="{{route('pembobotan.storeLmu')}}" method="post">
                        @csrf
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @foreach ($kriteria as $x => $_item)
                                    <td>
                                        <input style="width:100px" type="number" step="0.00000000001" class="form-control" name="pembobotan[{{$item->id_kri}}][{{$_item->id_kri}}][l]" value="{{$tablePembobotanLmu[$item->id_kri][$_item->id_kri]['l']}}">
                                    </td>
                                    <td>
                                        <input style="width:100px" type="number" step="0.00000000001" class="form-control" name="pembobotan[{{$item->id_kri}}][{{$_item->id_kri}}][m]" value="{{$tablePembobotanLmu[$item->id_kri][$_item->id_kri]['m']}}">
                                    </td>
                                    <td>
                                        <input style="width:100px" type="number" step="0.00000000001" class="form-control" name="pembobotan[{{$item->id_kri}}][{{$_item->id_kri}}][u]" value="{{$tablePembobotanLmu[$item->id_kri][$_item->id_kri]['u']}}">
                                    </td>
                                    @endforeach
                                </tr>
                                @endforeach
                    ...
                    <table class="table table-bordered" style="margin-top: 20px">
                        <thead>
                            <tr>
                                <td rowspan="2">Kriteria</td>
                                <td colspan="3">{{$kriteria->first()->nama_kri}}</td>
                            </tr>
                            <tr>
                                <td>L</td>
                                <td>M</td>
